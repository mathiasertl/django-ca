...
class AcmeCertificate(models.Model):
    ...
    slug = models.SlugField(unique=True, default=acme_slug)
    order = models.ForeignKey(AcmeOrder, on_delete=models.CASCADE, unique=True)
    cert = models.ForeignKey(Certificate, on_delete=models.CASCADE, unique=True, null=True)

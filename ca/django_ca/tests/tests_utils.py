...
class ParseGeneralNameTest(DjangoCATestCase):
    ...
    def test_otherName_octetString(self):
        self.assertEqual(parse_general_name('otherName:1.3.6.1.4.1.311.25.1;OctetString:09CFF1A8F6DEFD4B85CE95FFA1B54217'),
                         x509.OtherName(x509.oid.ObjectIdentifier('1.3.6.1.4.1.311.25.1', 'Unknown OID'),

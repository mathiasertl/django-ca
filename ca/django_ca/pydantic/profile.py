...
from django_ca.typehints import ConfigurableExtensionKeys, HashAlgorithms, Self

ExtensionKey = ConfigurableExtensionKeys
...
ExtensionDict = Annotated[
    dict[ConfigurableExtensionKeys, ConfigurableExtensionModel | None],

# Generated by Django 3.1.4 on 2020-12-08 18:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kid', models.URLField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='django_ca.acmeaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='authorizations', to='django_ca.acmeorder')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='ca',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ca.certificateauthority'),
        ),
        migrations.CreateModel(
            name='AcmeChallenge',
            fields=[
                ...
                ('auth', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='challenges', to='django_ca.acmeauthorization')),
            ],
            options={

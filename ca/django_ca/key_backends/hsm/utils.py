...
def decode_eddsa_private_key(der: bytes) -> dict[pkcs11.Attribute, str | int | bytes]:
...
def decode_eddsa_public_key(
    der: bytes, encode_eddsa_point: bool = True
) -> dict[pkcs11.Attribute, str | int | bytes]:

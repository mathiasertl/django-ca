...
class Profile:
    ...
    def __init__(self, name, subject=None, algorithm=None, extensions=None, cn_in_san=True,
    ...
    def create_cert(self, ca, csr, subject=None, expires: Expires = None, algorithm=None, extensions=None,

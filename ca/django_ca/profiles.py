...
ExtensionTypes = typing.Union[x509.Extension[x509.ExtensionType], Extension[Any, Any, Any]]
...
class Profile:
    ...
    extensions: Dict[str, typing.Optional[x509.Extension[x509.ExtensionType]]]
    ...
    def __init__(
        ...
        extensions: Optional[
            Dict[str, typing.Optional[typing.Union[ParsableExtension, x509.Extension[x509.ExtensionType]]]]
        ] = None,
        cn_in_san: bool = True,
        ...
        self.extensions: Dict[str, typing.Optional[x509.Extension[x509.ExtensionType]]] = {}
        ...
        for key, extension in extensions.items():
            if isinstance(extension, x509.Extension):
                ...
                self.extensions[key] = extension.as_extension()
            elif extension is None:
                self.extensions[key] = None
            else:
                self.extensions[key] = parse_extension(key, extension)
    ...
    def serialize(self) -> SerializedProfile:
        ...
        """
        extensions: typing.Dict[str, typing.Optional[SerializedExtension]] = {}

        for key, extension in self.extensions.items():
            if extension is None:
                extensions[key] = None
            else:
                extensions[key] = serialize_extension(extension)

    ...
    def create_cert(
        ...
        **kwargs: Any,
        ...
        .. deprecated:: 1.18.0
           ...
           Passing ``str`` or ``bytes`` for the `csr` parameter is deprecated and will be removed in django-ca
           1.20.0. The `csr_format` parameter will be removed in the same version.

...
class CertificateManagerMixin(Generic[X509CertMixinTypeVar, QuerySetTypeVar]):
    ...
    if typing.TYPE_CHECKING:
        ...
        def for_ocsp_cache(self, *, now: datetime | None = None) -> "CertificateQuerySet": ...
...
class CertificateAuthorityManager(
    ...
    def _get_formatting_context(self, serial: int, signer_serial: int) -> dict[str, int | str]:
    ...
    def _handle_crl_distribution_point(
        self, hostname: str | None, extensions: CertificateExtensionDict
    ) -> None:
    ...
    def init(  # noqa: PLR0912,PLR0913,PLR0915
        ...
        default_hostname: bool | str | None = None,
        path_length: int | None = None,
        key_type: ParsableKeyType = "RSA",
        extensions: Iterable[CertificateExtension] | None = None,
        caa: str = "",
        website: str = "",
        ...
        sign_authority_information_access: x509.Extension[x509.AuthorityInformationAccess] | None = None,
        sign_certificate_policies: x509.Extension[x509.CertificatePolicies] | None = None,
        sign_crl_distribution_points: x509.Extension[x509.CRLDistributionPoints] | None = None,
        sign_issuer_alternative_name: x509.Extension[x509.IssuerAlternativeName] | None = None,
        ocsp_key_backend_alias: str = "default",
        ocsp_responder_key_validity: int | None = None,
        ocsp_response_validity: int | None = None,
        ...
        ca.run_generate_ocsp_response_task()
        return ca
    ...
    def create_cert(  # noqa: PLR0913
        ...
        *,
        ...
        .. versionchanged:: 2.4.0
           ...
           * All arguments except `ca`, `key_backend_options`, `csr` and `profile` must now be given as
             keyword arguments.
        ...
        obj.run_generate_ocsp_response_task()
...
class CertificateRevocationListManager(CertificateRevocationListManagerBase):
    ...
    if typing.TYPE_CHECKING:
        ...
        def newest(self) -> "CertificateRevocationList" | None: ...
    ...
    def _add_issuing_distribution_point_extension(
        ...
        *,
        ...
        only_some_reasons: frozenset[x509.ReasonFlags] | None,

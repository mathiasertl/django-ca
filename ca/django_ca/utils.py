...
@typing.overload
def generate_private_key(key_size: int, key_type: Literal["EdDSA"], ecc_curve: None) -> ed25519.Ed25519PrivateKey:
    ...


def generate_private_key(
    key_size: Optional[int], key_type: Literal["RSA", "DSA", "ECC", "EdDSA"], ecc_curve: Optional[ec.EllipticCurve]
) -> PrivateKeyTypes:

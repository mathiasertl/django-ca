...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'certificate_certificate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('expires', self.gf('django.db.models.fields.DateTimeField')()),
            ('csr', self.gf('django.db.models.fields.TextField')()),
            ('pub', self.gf('django.db.models.fields.TextField')()),
    ...
    models = {
        ...
        u'certificate.certificate': {
            ...
            'csr': ('django.db.models.fields.TextField', [], {}),
            'expires': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub': ('django.db.models.fields.TextField', [], {}),
            'watchers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'})
        },

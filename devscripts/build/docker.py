...
class Command(DevCommand):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--upload", dest="docker_upload", default=False, action="store_true", help="Upload Docker image."
        )
    ...
    def handle(self, args: argparse.Namespace) -> None:
        ...
        # Create revision tag and latest tag.
        self.run("docker", "tag", tag, f"{tag}-{args.revision}")
